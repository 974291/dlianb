...
<head>
	...
	<link href="/dlianb/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/theme.min.css" rel="stylesheet">
    <link href="/dlianb/public/simpleboot/css/simplebootadmin.css" rel="stylesheet">
    <link href="/dlianb/public/js/artDialog/skins/default.css" rel="stylesheet" />
    <link href="/dlianb/public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
    <style>
	...
	<!--[if IE 7]>
	<link rel="stylesheet" href="/dlianb/public/simpleboot/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
	<![endif]-->
...
<!-- Le javascript
    ...
    <script src="/dlianb/public/js/jquery.js"></script>
    <script src="/dlianb/public/js/wind.js"></script>
    <script src="/dlianb/public/simpleboot/bootstrap/js/bootstrap.min.js"></script>
...
<body>
							...
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<?php if(!empty($site_admin_url_password)): ?><span class="help-block">后台地址：<span id="js-site-admin-url"><?php echo sp_get_host();?>/dlianb?g=admin&upw=<?php echo C('SP_SITE_ADMIN_URL_PASSWORD');?></span></span><?php endif; ?>
									</div>
								</div>
								<div class="control-group">
	...
	<script type="text/javascript" src="/dlianb/public/js/common.js"></script>
	<script>
		/////---------------------
		$(function(){
