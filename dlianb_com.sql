...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-04-11 03:25:22
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `dlianb_ad` (
...
CREATE TABLE IF NOT EXISTS `dlianb_admin` (
  `id` int(255) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `loginuser` varchar(32) NOT NULL COMMENT '管理帐号',
  `loginpass` varchar(32) NOT NULL COMMENT '管理密码',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `dlianb_area` (
  `id` int(255) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `status` int(1) unsigned NOT NULL DEFAULT '1' COMMENT '区别1为电信2为网通',
  `area` varchar(255) NOT NULL COMMENT '区域类别电信网通',
  `areas` varchar(255) NOT NULL COMMENT '区域分类',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='区域分类' AUTO_INCREMENT=5 ;

--
-- 转存表中的数据 `dlianb_area`
--

INSERT INTO `dlianb_area` (`id`, `status`, `area`, `areas`) VALUES
(1, 1, '电信', '艾欧尼亚'),
(2, 2, '网通', '网通'),
(3, 1, '电信', '电信'),
(4, 1, '教育', '教育');
...
CREATE TABLE IF NOT EXISTS `dlianb_asset` (
...
--
-- 表的结构 `dlianb_auth_access`
--

CREATE TABLE IF NOT EXISTS `dlianb_auth_access` (
...
--
-- 表的结构 `dlianb_auth_rule`
--

CREATE TABLE IF NOT EXISTS `dlianb_auth_rule` (
...
--
-- 转存表中的数据 `dlianb_auth_rule`
--

INSERT INTO `dlianb_auth_rule` (`id`, `module`, `type`, `name`, `param`, `title`, `status`, `condition`) VALUES
...
--
-- 表的结构 `dlianb_comments`
--

CREATE TABLE IF NOT EXISTS `dlianb_comments` (
...
--
-- 表的结构 `dlianb_common_action_log`
--

CREATE TABLE IF NOT EXISTS `dlianb_common_action_log` (
...
--
-- 表的结构 `dlianb_guestbook`
--

CREATE TABLE IF NOT EXISTS `dlianb_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dlianb_indent` (
  `id` int(255) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `tid` int(255) unsigned DEFAULT NULL COMMENT '发布用户ID',
  `uid` int(255) unsigned NOT NULL COMMENT '中标用户ID',
  `title` text NOT NULL COMMENT '订单标题',
  `uname` varchar(35) NOT NULL COMMENT '发布者名字',
  `img` varchar(255) NOT NULL COMMENT '订单图像',
  `num` int(255) NOT NULL COMMENT '投标人数',
  `reward` int(255) unsigned DEFAULT NULL COMMENT '订单赏金',
  `state` int(1) unsigned NOT NULL DEFAULT '1' COMMENT '赏金状态1：未托管2：已托管',
  `status` int(1) unsigned NOT NULL DEFAULT '1' COMMENT '订单状态1:公示中2:已接单3:代练中4:交付中5:结算中6:完成订单',
  `urgent` int(1) unsigned NOT NULL DEFAULT '1' COMMENT '是否加急',
  `lasttime` int(11) unsigned NOT NULL COMMENT '剩余时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='订单列表' AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `dlianb_indent`
--

INSERT INTO `dlianb_indent` (`id`, `tid`, `uid`, `title`, `uname`, `img`, `num`, `reward`, `state`, `status`, `urgent`, `lasttime`) VALUES
(1, 1, 1, '黄金3代练', 'admin', '0c78a.png', 552, 50000, 1, 6, 1, 20150905),
(2, 2, 1, '黄金3代练黄金3代练黄金3代练黄金3代练黄金3代练黄金3代练黄金3代练黄金3代练黄金3代练黄金3代练黄金3代练黄金3代练黄金3代练黄金3代练黄金3代练黄金3代练', 'admin', '0c78a.png', 552, 50050, 1, 6, 1, 20150905);
...
CREATE TABLE IF NOT EXISTS `dlianb_links` (
...
--
-- 转存表中的数据 `dlianb_links`
--

INSERT INTO `dlianb_links` (`link_id`, `link_url`, `link_name`, `link_image`, `link_target`, `link_description`, `link_status`, `link_rating`, `link_rel`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `dlianb_menu` (
...
INSERT INTO `dlianb_menu` (`id`, `parentid`, `app`, `model`, `action`, `data`, `type`, `status`, `name`, `icon`, `remark`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `dlianb_message` (
  `id` int(255) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `img` varchar(255) NOT NULL COMMENT '图片',
  `title` text NOT NULL COMMENT '文章头',
  `content` text NOT NULL COMMENT '内容',
  `time` int(11) NOT NULL COMMENT '时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='资讯' AUTO_INCREMENT=4 ;

--
-- 转存表中的数据 `dlianb_message`
--

INSERT INTO `dlianb_message` (`id`, `img`, `title`, `content`, `time`) VALUES
(1, '8242.jpg', '特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日特价今日', '本站今日特价', 41567987),
(2, '8242.jpg', '顶戴云蒸霞蔚的股份制租赁 遥', '本站今日特价', 41567987),
(3, '8242.jpg', '蠯后眩原来玫', '本站今日特价', 41567987);
...
CREATE TABLE IF NOT EXISTS `dlianb_money` (
  `id` int(255) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `cid` int(255) unsigned DEFAULT NULL COMMENT '用户ID',
  `date` int(11) DEFAULT NULL COMMENT '充值日期',
  `integral` int(255) unsigned DEFAULT NULL COMMENT '用户积分',
  PRIMARY KEY (`id`),
  UNIQUE KEY `cid` (`cid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户资金' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `dlianb_nav` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `dlianb_nav` (`id`, `cid`, `parentid`, `label`, `target`, `href`, `icon`, `status`, `listorder`, `path`) VALUES
...
CREATE TABLE IF NOT EXISTS `dlianb_nav_cat` (
...
--
-- 转存表中的数据 `dlianb_nav_cat`
--

INSERT INTO `dlianb_nav_cat` (`navcid`, `name`, `active`, `remark`) VALUES
(1, '主导航', 1, '主导航');
...
CREATE TABLE IF NOT EXISTS `dlianb_notice` (
  `id` int(255) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `status` int(1) NOT NULL COMMENT '文章类型1:公告2:中标通知3:提现公告',
...
--
-- 表的结构 `dlianb_oauth_user`
--

CREATE TABLE IF NOT EXISTS `dlianb_oauth_user` (
...
CREATE TABLE IF NOT EXISTS `dlianb_office` (
  `id` int(255) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `aid` int(255) unsigned NOT NULL COMMENT '所属用户id',
  `qid` int(255) unsigned NOT NULL COMMENT '区域ID',
  `title` text NOT NULL COMMENT '公作室名称',
  `goods` varchar(255) NOT NULL COMMENT '商品名字',
  `img` varchar(255) NOT NULL COMMENT '工作室头像',
  `service` varchar(255) NOT NULL COMMENT '服务范围',
  `qq` int(12) unsigned NOT NULL COMMENT '联系QQ',
  `honor` text NOT NULL COMMENT '职业打手',
  `dan` text NOT NULL COMMENT '打手段位',
  `type` int(255) NOT NULL COMMENT '成交次数',
  `haop` int(255) NOT NULL COMMENT '好评数',
  `chap` int(255) NOT NULL COMMENT '差评数',
  `sump` int(255) NOT NULL COMMENT '总评',
  `recommend` int(1) NOT NULL DEFAULT '2' COMMENT '1.推荐2.不推荐',
  `money` int(255) NOT NULL COMMENT '售价',
  `time` int(11) NOT NULL COMMENT '时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='工作室' AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `dlianb_office`
--

INSERT INTO `dlianb_office` (`id`, `aid`, `qid`, `title`, `goods`, `img`, `service`, `qq`, `honor`, `dan`, `type`, `haop`, `chap`, `sump`, `recommend`, `money`, `time`) VALUES
(1, 1, 1, '天涯工作室', '黄金到白金', 'man_big.jpg', '英雄联盟', 565656, '职业打手', '电一王者', 1, 100, 1, 101, 1, 500, 7878788),
(2, 2, 2, '天涯工作室', '黄金到白金', 'man_big.jpg', '255454', 565656, '职业打手', '电一王者', 1, 100, 1, 101, 2, 5000, 7878788);
...
CREATE TABLE IF NOT EXISTS `dlianb_options` (
...
--
-- 转存表中的数据 `dlianb_options`
--

INSERT INTO `dlianb_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
...
(2, 'site_options', '{"site_name":"\\u4e2d\\u56fd\\u7f51\\u6e38\\u4ee3\\u7ec3\\u5427","site_host":"http:\\/\\/localhost\\/","site_admin_url_password":"","site_tpl":"dlianb","site_adminstyle":"bluesky","site_icp":"","site_admin_email":"974291@qq.com","site_tongji":"","site_copyright":"","site_seo_title":"\\u5e26\\u573a\\u00b7\\u4ee3\\u7ec3\\u00b7\\u966a\\u73a9\\u00b7\\u4e13\\u4e1a\\u7684\\u6e38\\u620f\\u670d\\u52a1\\u5e73\\u53f0!","site_seo_keywords":"\\u4ee3\\u7ec3,\\u4e2d\\u56fd\\u7f51\\u6e38\\u4ee3\\u7ec3\\u5427,\\u82f1\\u96c4\\u8054\\u76df,\\u6e38\\u620f\\u4ee3\\u7ec3","site_seo_description":"\\u4e2d\\u56fd\\u7f51\\u6e38\\u4ee3\\u7ec3\\u5427dlianb.com\\uff0c\\u662f\\u56fd\\u5185\\u4e13\\u4e1a\\u7684\\u6e38\\u620f\\u670d\\u52a1\\u5e73\\u53f0\\uff0c\\u5e26\\u573a\\u3001\\u4ee3\\u7ec3\\u3001\\u966a\\u73a9\\uff0c\\u90fd\\u5728\\u8fd9\\u91cc\\u4e86\\uff0c\\u6211\\u4eec\\u62e5\\u6709\\u900f\\u660e\\u7684\\u9700\\u6c42\\u3001\\u516c\\u5f00\\u7684\\u62a5\\u4ef7\\uff0c\\u8fd9\\u91cc\\u662f\\u9ad8\\u5927\\u4e0a\\u6e38\\u620f\\u7684\\u70ed\\u95e8\\u4e92\\u52a8\\u548c\\u670d\\u52a1\\u5e73\\u53f0\\u3002","urlmode":"1","html_suffix":".html","comment_time_interval":60}', 1),
...
CREATE TABLE IF NOT EXISTS `dlianb_plugins` (
...
CREATE TABLE IF NOT EXISTS `dlianb_posts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dlianb_role` (
...
INSERT INTO `dlianb_role` (`id`, `name`, `pid`, `status`, `remark`, `create_time`, `update_time`, `listorder`) VALUES
(1, '超级管理员', 0, 1, '拥有网站最高管理员权限！', 1329633709, 1329633709, 0);

-- --------------------------------------------------------

--
-- 表的结构 `dlianb_role_user`
--

CREATE TABLE IF NOT EXISTS `dlianb_role_user` (
...
CREATE TABLE IF NOT EXISTS `dlianb_route` (
...
CREATE TABLE IF NOT EXISTS `dlianb_slide` (
...
--
-- 表的结构 `dlianb_slide_cat`
--

CREATE TABLE IF NOT EXISTS `dlianb_slide_cat` (
...
CREATE TABLE IF NOT EXISTS `dlianb_terms` (
...
--
-- 转存表中的数据 `dlianb_terms`
--

INSERT INTO `dlianb_terms` (`term_id`, `name`, `slug`, `taxonomy`, `description`, `parent`, `count`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `listorder`, `status`) VALUES
...
--
-- 表的结构 `dlianb_term_relationships`
--

CREATE TABLE IF NOT EXISTS `dlianb_term_relationships` (
...
CREATE TABLE IF NOT EXISTS `dlianb_users` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `dlianb_users`
--

INSERT INTO `dlianb_users` (`id`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `avatar`, `sex`, `birthday`, `signature`, `last_login_ip`, `last_login_time`, `create_time`, `user_activation_key`, `user_status`, `score`, `user_type`, `coin`, `mobile`) VALUES
(1, 'admin', '###4d7d9faf66243bb65fc0c821f76cae01', 'admin', '974291@qq.com', '', NULL, 0, NULL, NULL, '0.0.0.0', '2016-04-08 17:07:33', '2016-04-08 09:27:15', '', 1, 0, 1, 0, ''),
(2, 'sxglboy', '###c8de1896122c6540c244ab22e32e334b', '', '974291@qq.com', '', NULL, 0, NULL, NULL, NULL, '2000-01-01 00:00:00', '2000-01-01 00:00:00', '', 1, 0, 2, 0, '');

-- --------------------------------------------------------

--
-- 表的结构 `dlianb_user_favorites`
--

CREATE TABLE IF NOT EXISTS `dlianb_user_favorites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
